...
@Component
@AllArgsConstructor
public class MappingWrapperClassParser {
    public MappingWrapperClassCode parse(String classCode) {
        var classCodeStrBuilder = new StringBuilder(classCode);
        MappingWrapperClassCode mappingWrapperClassCode = new MappingWrapperClassCode();
