...
public class AppJsonMapperConfig {
    ...
    public AppJsonMapper getAppJsonMapper(Gson gson, MaskedFieldsConfig maskedFieldsConfig) {
        return new JsonMapperWithClassName(gson, maskedFieldsConfig);
    }

    @Bean("masked_field_json_mapper")
    public AppJsonMapper getMaskedFieldJsonMapperTest(Gson gson, MaskedFieldsConfig maskedFieldsConfig) {
