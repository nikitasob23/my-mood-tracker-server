# Документация API сервиса authorization-service
Open API v1.0.0
...
3. **jjwt-jackson** и **gson** -  библиотеки, предоставляющие функицонал для работы с JSON
3. 
